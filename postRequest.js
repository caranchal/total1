...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            const response = await fetch('https://backendx-production-c33e.up.railway.app/api/submit', { // Или твой URL backend'а (в проде — https://your-backend.com/api/submit)
                method: 'POST',
                headers: {
